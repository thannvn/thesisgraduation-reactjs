  ...
  return (
    <Paper className='b-profile-info h-mr-10'>
      <form className='b-profile' onSubmit={handleSubmit(handleSaveEdit)}>
        ...
        <Typography className='p-name h-mt-32'>
          {state.userInfo.name}
        </Typography>

        <Typography className='p-username'>
        ...
        <div className='p-icon-text-input'>
          ...
          {!state.isEdit && state.userInfo.dateOfBirth && (
            <>
              <CakeOutlined className='p-icon' />
              <Typography className='h-ml-8'>
                {state.userInfo.dateOfBirth}
              </Typography>
            </>
          )}
        </div>
        ...
        {state.isEdit && (
          <div className='h-mt-20'>
            <button className='p-button-edit p-btn-save' type='submit'>
              Lưu
            </button>
            <button
